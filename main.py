...
def attack(char_name: str, char_class: str) -> str:
    """Функция расчета атаки в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция расчета защиты в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Фунция расчета специальной атаки в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки в зависимоти от класса персонажа."""
    if char_class == 'warrior':
